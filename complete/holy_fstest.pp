...
# 9 "./include/holy/emu/misc.h"
# 1 "./config.h" 1
# 38 "./config.h"
# 1 "./config-util.h" 1
# 39 "./config.h" 2
# 10 "./include/holy/emu/misc.h" 2
...
# 15 "./include/holy/misc.h" 2
# 26 "./include/holy/misc.h"
...
# 402 "./include/holy/misc.h"
void holy_halt (void) __attribute__ ((noreturn));
# 412 "./include/holy/misc.h"
static inline void
  ...
  if (holy_disk_firmware_fini)
    {
      ...
      holy_disk_firmware_fini = 
# 219 "./include/holy/disk.h" 3 4
                               ((void *)0)
# 219 "./include/holy/disk.h"
                                   ;
    }
}
...
# 1426 "./include/holy/elf.h"
typedef struct
{
  Elf32_Word hwp_flags1;
  Elf32_Word hwp_flags2;
} Elf_Options_Hw;
# 1565 "./include/holy/elf.h"
typedef struct
{
  Elf32_Word l_name;
...
{
  holy_list_push ((((char *) &(*&holy_partition_map_list)->next == (char *) &((holy_list_t) (*&holy_partition_map_list))->next) && ((char *) &(*&holy_partition_map_list)->prev == (char *) &((holy_list_t) (*&holy_partition_map_list))->prev) ? (holy_list_t *) (void *) &holy_partition_map_list : (holy_list_t *) holy_bad_type_cast_real(93, "util/holy-fstest.c")),
    (((char *) &(partmap)->next == (char *) &((holy_list_t) (partmap))->next) && ((char *) &(partmap)->prev == (char *) &((holy_list_t) (partmap))->prev) ? (holy_list_t) partmap : (holy_list_t) holy_bad_type_cast_real(94, "util/holy-fstest.c")));
}
...
{
  holy_list_remove ((((char *) &(partmap)->next == (char *) &((holy_list_t) (partmap))->next) && ((char *) &(partmap)->prev == (char *) &((holy_list_t) (partmap))->prev) ? (holy_list_t) partmap : (holy_list_t) holy_bad_type_cast_real(101, "util/holy-fstest.c")));
}
...
{
  holy_list_push ((((char *) &(*&holy_fs_list)->next == (char *) &((holy_list_t) (*&holy_fs_list))->next) && ((char *) &(*&holy_fs_list)->prev == (char *) &((holy_list_t) (*&holy_fs_list))->prev) ? (holy_list_t *) (void *) &holy_fs_list : (holy_list_t *) holy_bad_type_cast_real(103, "util/holy-fstest.c")), (((char *) &(fs)->next == (char *) &((holy_list_t) (fs))->next) && ((char *) &(fs)->prev == (char *) &((holy_list_t) (fs))->prev) ? (holy_list_t) fs : (holy_list_t) holy_bad_type_cast_real(103, "util/holy-fstest.c")));
}
...
{
  holy_list_remove ((((char *) &(fs)->next == (char *) &((holy_list_t) (fs))->next) && ((char *) &(fs)->prev == (char *) &((holy_list_t) (fs))->prev) ? (holy_list_t) fs : (holy_list_t) holy_bad_type_cast_real(110, "util/holy-fstest.c")));
}
...
# 12 "./include/holy/emu/hostdisk.h"
# 1 "./include/holy/emu/hostfile.h" 1
# 12 "./include/holy/emu/hostfile.h"
# 1 "./include/holy/osdep/hostfile.h" 1
# 11 "./include/holy/osdep/hostfile.h"
...
holy_uint32_t
holy_util_get_mtime (const char *name);
# 13 "./include/holy/emu/hostdisk.h" 2
...
void holy_mdraid1x_fini (void);
void holy_diskfilter_fini (void);
# 11 "holy-core/disk/host.c" 2

# 1 "./include/holy/emu/hostdisk.h" 1
# 10 "./include/holy/emu/hostdisk.h"
# 1 "./include/holy/partition.h" 1
# 12 "./include/holy/partition.h"
struct holy_disk;
...
# 11 "./include/holy/emu/hostdisk.h" 2
# 1 "/usr/include/x86_64-linux-gnu/sys/types.h" 1 3 4
# 27 "/usr/include/x86_64-linux-gnu/sys/types.h" 3 4
...
# 12 "./include/holy/emu/hostdisk.h" 2
# 1 "./include/holy/emu/hostfile.h" 1
# 12 "./include/holy/emu/hostfile.h"
# 1 "./include/holy/osdep/hostfile.h" 1
# 11 "./include/holy/osdep/hostfile.h"
