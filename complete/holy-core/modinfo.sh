...
# Build environment
holy_target_cc='gcc'
holy_target_cc_version='gcc (Ubuntu 13.3.0-6ubuntu2~24.04) 13.3.0'
...
holy_target_cppflags=' -Wall -W  -Dholy_MACHINE_PCBIOS=1 -Dholy_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/13/include -I$(top_srcdir)/include -I$(top_builddir)/include'
holy_target_ccasflags=' -g  -m32 -msoft-float'
holy_target_ldflags=' -m32 -Wl,-melf_i386 -no-pie -Wl,--build-id=none'
holy_cflags=''
holy_cppflags=' -D_FILE_OFFSET_BITS=64'
holy_ccasflags=''
holy_ldflags=''
...
holy_package_bugreport="bug-holy@gnu.org"
